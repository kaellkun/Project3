 ...
 * @default {"太さ":"8","タッチ範囲太さ":"30","縁取り幅":"1","バー本体-色タイプ":"単色","バー本体色":"255, 128, 0, 1","バー本体色-グラデ":"255, 255, 255, 1","バー背景色":"96, 96, 96, 1","丸み":"5"}
 * 
 * @param 一覧モード
 * 
 * @param 一覧モード有効
 ...
 * @default {"ロングタッチ":"","ロングタッチ時間":"15","スワイプキャンセル":"","メニュー以外にも適用":"true","キャンセルエリア幅":"gw * 0.1","キャンセル遊び":"30","スワイプスライド":"","連鎖スライド時間":"0","スライドエリア幅":"gw * 0.8","スライド遊び":"30"}
 * 
 * @param タッチ演出
 * 
 * @param タッチスター表示
 ...
 * @param 装備リスト列数
 * @parent 装備
 * @desc equipListCols 装備変更時のリストの列数。2 なら2列
 * @default 1
 * 
 * @param 装備所持数を非表示
 * @parent 装備
 * @desc hideItemNumber 装備変更リストでは装備の所持数を表示しないようにする
 * @type boolean
 * @default false
 * 
 * @param 装備外すUI
 * @parent 装備
 * @desc equipRemoveUI　装備変更リストにおける、装備外しのUI設定
 * @type struct<equipRemoveUi>
 * @default {}
 * 
 * @param セーブ
 * 
 ...
 * @param 補欠マーク表示
 * @parent 戦闘メンバー強調
 * @desc subMark 戦闘に参加しないメンバーにマークを付ける
 * @type boolean
 * @default true
 * 
 * @param バトラーマーク設定
 ...
 * @default {"表示":"true","テキスト":"Battler","補欠テキスト":"Sub","文字サイズ":"16","文字色":"255, 192, 0","縁取り幅":"6","配置":"左下","ずらしX":"0","ずらしY":"0"}
 * 
 * @param アイコンバック
 * 
 * @param アイコンバック表示
 ...
 * @param ステータス表示項目
 * @parent 表示項目カスタム
 * @desc statusShowContents ステータスのどの項目を表示するかの設定
 * @type struct<statusShowContents>
 * @default {"レベルの表示":"表示","HPの表示":"表示","MPの表示":"表示","TPの表示":"表示"}
 * 
 * @param 競合対策
 * 
 * @param 競合対策シーン
...
//==================================================
 * @param 配置方向
 * @desc putDire スクロールバーの配置方向。左か右か。基本 右
 * @type select
 * @option 左
 * @option 右
 * @default 右
 * 
 * @param 太さ
 * @desc width スクロールバーの太さ。5 なら 5ピクセル。基本 8
 * @default 8
 * 
 * @param タッチ範囲太さ
 ...
 * @param キャンセルエリア幅
 * @parent スワイプキャンセル
 * @desc swipeAreaWidth 画面左端と右端のスワイプキャンセルエリアの横幅。50 なら 50ピクセル。演算可。gw:画面横幅。基本 gw * 0.1
 * @default gw * 0.1
 * 
 * @param キャンセル遊び
 * @parent スワイプキャンセル
 * @desc swipeCancelPlay スワイプキャンセルの遊び(発動しない距離)。5 なら 5ピクセル。基本 20
 * @default 20
 * 
 * @param スワイプスライド
 * 
 ...
 * @param スライドエリア幅
 * @parent スワイプスライド
 * @desc swipeAreaWidth 画面中央のスワイプスライドエリアの横幅。50 なら 50ピクセル。演算可。gw:画面横幅。基本 gw * 0.8
 * @default gw * 0.8
 * 
 * @param スライド遊び
 * @parent スワイプスライド
 * @desc swipeSlidePlay スワイプスライドの遊び(発動しない距離)。5 なら 5ピクセル。基本 20
 * @default 20
*/
...
//==================================================
/*~struct~equipRemoveUi:
//==================================================
 * @param テキストを表示
 * @desc showText 装備変更リストの、装備外し欄(空欄部分)にテキストを表示する
 * @type booelan
 * @default true
 * 
 * @param └テキスト内容
 * @desc textContents 装備外し欄に表示するテキスト内容
 * @default 外す
 * 
 * @param 装備外し欄の位置
 * @desc equipRemoveSpacePos 装備変更リストにおける装備外し欄の位置。最初か最後か
 * @type select
 * @option 最初
 * @option 最後
 * @default 最初
 ...
 * @param 職業-ずらしY
 * @parent 職業表示
 * @desc class-offsetY 職業のY位置ずらし。5 なら 5ピクセル 下へ。基本 25
 * @default 25
 * 
 * @param 職業-文字サイズ
 * @parent 職業表示
 ...
 * 
 * @param 補欠テキスト
 * @desc subText 補欠マークの表示テキスト。基本 sub
 * @default sub
 * 
 * @param 文字サイズ
 * @desc fontSize バトラーマークの文字サイズ。基本 16
 * @default 16
 * 
 * @param 文字色
...
//==================================================
/*~struct~statusShowContents:
//==================================================
 * @param レベルの表示
 * @desc showLevel レベルの表示設定
 * @type boolean
 * @type select
 * @option 表示
 * @option 表示しない
...
(() => {
    ...
    //- アイコンバックのを描画するか(公開)
    Game_Temp.prototype.isIconBackDrawKe = function() {
        return isIconBackDraw();
    };
    ...
    //- ステータス表示するか(公開)
    Game_Temp.prototype.isStatusShowKeMncf = function(...args) {
        return isStatusShow(...args);
    };

    //- 追加ロングタッチしたか(公開)
    Game_Temp.prototype.isLongTouchExKeMncf = function() {
        return isLongTouchEx();
    };
    ...
    //- 顔グラメイクへのクリア
    function clearToFaceMake(actor, windo) {
        if (!$gameTemp.clearToFaceMakeKe) { return; }
        $gameTemp.clearToFaceMakeKe.apply(this, arguments);
    };
    ...
    const keke_hideEquipItemNumber = toBoolean(parameters["装備所持数を非表示"]);
    const keke_equipRemoveUi = strToHash(parameters["装備外すUI"]);
    ...
    const keke_showSubMark = toBoolean(parameters["補欠マーク表示"]);
    ...
    //- 表示項目カスタム
    const keke_statusShowContents = strToHash(parameters["ステータス表示項目"]);
    ...
    Window_Selectable.prototype.processHandling = function() {
        ...
        if (this.isOpenAndActive()) {
            if (!this.isHandled("left") && this.isHandled("pageup")) {
                ...
                // ホイール上(スキルリストの場合は除外)
                if (TouchInput.wheelY < 0 && !this._wheelWaitUp && !isHoverListWindow()) { ok = true; }
                if (ok) {
            ...
            if (!this.isHandled("right") && this.isHandled("pagedown")) {
                ...
                // ホイール下(スキルリストの場合は除外)
                if (TouchInput.wheelY > 0 && !this._wheelWaitdown && !isHoverListWindow()) { ok = true; }
                if (ok) {
    ...
    //- リストウインドウをオーバー中か
    function isHoverListWindow() {
        // リストウインドウを取得
        const scene = SceneManager._scene;
        const itemWindow = scene._itemWindow;
        if (!itemWindow) { return false; }
        // データ数が 0 ならfalse
        const data = itemWindow._data;
        if (data && data.length == 0)  { return false;}
        // 一人パーティでないなら false
        if ($gameParty.members().length > 1) { return false; }
        // ウインドウオーバー中か
        return isWindowOver(itemWindow);
    };

    //- ウインドウオーバー中か
    function isWindowOver(windo) {
        // マウスオーバーしているか判定
        const touchPos = new Point(TouchInput.x, TouchInput.y);
        const localPos = windo.worldTransform.applyInverse(touchPos);
        return windo.innerRect.contains(localPos.x, localPos.y)
    };
    ...
    //- シーンエクイップ/アイテムウインドウの形成(処理追加)
    const _Scene_Equip_createItemWindow = Scene_Equip.prototype.createItemWindow;
    Scene_Equip.prototype.createItemWindow = function() {
        _Scene_Equip_createItemWindow.apply(this);

        // 装備選択中もページキーでのキャラ繰り替えを可能にする
        this._itemWindow.setHandler("pagedown", this.nextActor.bind(this));
        this._itemWindow.setHandler("pageup", this.previousActor.bind(this));
    };

    //- シーンエクイップ/ページボタン有効か(処理追加)
    ...
    Scene_Equip.prototype.arePageButtonsEnabled = function() {
        ...
        return _Scene_Equip_arePageButtonsEnabled.apply(this);
    };


    //- ゲームアクター/強制的な装備変更(処理追加)
    ...
    TouchInput._onTrigger = function(x, y) {
        ...
        // タッチタイプを保存
        this._touchTypeKe = { type:this._mousePressed ? "mouse" : this._screenPressed ? "screen" : "" };
    };


    //- タッチインブット/タッチ開始時の処理(処理追加)
    const _TouchInput_onTouchStart = TouchInput._onTouchStart;
    TouchInput._onTouchStart = function(event) {
        _TouchInput_onTouchStart.apply(this, arguments);

        // ツインタッチ時にロングタッチ済みフラグをオン
        if (this._screenPressed && event.touches.length >= 2) {
            this._longTouchedKeMncf = true;
        };
    };


    //- タッチインブット/タッチ移動時の処理(処理追加)
    ...
    TouchInput._onTouchEnd = function(event) {
        ...
        if (!event.touches.length) {
            // タッチ完全終了時の処理
            onTouchTerminate(this);
        }
    };

    //- タッチインブット/マウスキーを放した時の処理(処理追加)
    const _TouchInput_onMouseUp = TouchInput._onMouseUp;
    TouchInput._onMouseUp = function(event) {
        _TouchInput_onMouseUp.apply(this, arguments);
    ...
    //- タッチ完全終了時の処理
    function onTouchTerminate(touch) {
        // タッチタイプの消去開始
        startTouchTypeDel(touch);
        // ロングタッチの初期化
        initLongTouch(touch);
        // ロングタッチ回避フラグをオフ
        touch._noLongTouchKeMncf = false;
    };

    //- タッチタイプの消去開始
    function startTouchTypeDel(touch) {
        if (!touch._touchTypeKe) { return; }
        touch._touchTypeKe.count = 2;
    };
    
    //- タッチタイプの消去
    function delTouchType(touch) {
        if (!touch._touchTypeKe || !touch._touchTypeKe.count) { return; }
        touch._touchTypeKe.count--;
        if (!touch._touchTypeKe.count) {
    ...
    // アクティブウインドウの終了
    function endActiveWindow(windo, noCancel) {
        const scene = SceneManager._scene;
        if (!scene._activeWindowsKeMncf) { return; }
        const actives = scene._activeWindowsKeMncf;
        // 全ての保存ウインドウを処理
        ...
        actives.forEach((saveWindow, i) => {
            ...
            // 選択系ウインドウでなければリターン
            if (!(windo instanceof Window_Selectable)) { return; }
            // 保存ウインドウがコマンド系なら
    ...
    //- ウインドウ・スキルリスト/セレクトラスト(処理追加)
    const _Window_SkillList_selectLast = Window_SkillList.prototype.selectLast;
    Window_SkillList.prototype.selectLast = function() {
        // ダイレトクトタッチ時はタッチ位置を指す
        if (InDirectTouch || InLongTouchSelect) {
            this.onTouchSelect();
            return;
        }

        _Window_SkillList_selectLast.apply(this);
    };

    //- ウインドウ・アイテムリスト/セレクトラスト(処理追加)
    const _Window_ItemList_selectLast = Window_ItemList.prototype.selectLast;
    Window_ItemList.prototype.selectLast = function() {
        ...
        _Window_ItemList_selectLast.apply(this);
    };
    ...
    function updateLongTouchEx(touch) {
        ...
        // ロングタッチ回避ならリターン
        if (touch._noLongTouchKeMncf) { return; }
        // ロングタッチカウント
        ...
        if (touch._pressedTimeKeMncf <= 0) {
            ...
            // カウントを再開(2回目以降は半分)
            touch._pressedTimeKeMncf = Math.floor(keke_touchCfg["ロングタッチ時間"] * (touch._longTouchedKeMncf ? 0.5 : 1));
            // ロングタッチ済みフラグをオン
    ...
    //- ロングタッチの初期化
    function initLongTouch(touch) {
        touch._pressedTimeKeMncf = keke_touchCfg["ロングタッチ時間"] || 15;
        touch._longTouchedKeMncf = null;
    };
    ...
    function createCancelArea(scene) {
        ...
        const isMap = scene.constructor.name == "Scene_Map";
        const width = isMap ? 32 : Math.round(newFunc_screenW(keke_touchCfg["キャンセルエリア幅"])) || 32;
    ...
    function createSlideArea(scene) {
        ...
        const width = Math.round(newFunc_screenW(keke_touchCfg["スライドエリア幅"])) || 100;
        const height = Graphics.height;
    ...
    //- スプライトボタン/クリック時の処理(処理追加)
    const _Sprite_Button_onClick = Sprite_Button.prototype.onClick;
    Sprite_Button.prototype.onClick = function() {
        // 連鎖スライドの終了
        endChainSlide();

        _Sprite_Button_onClick.apply(this);
    };
    ...
    function createTouchStarSprite(starSprites, i, b) {
        ...
        // 描画
        if (b.form == "スクエア(四角形)") {
            fillSquare(bitmap, 0, 0, w, w, b.color, b.round);
    ...
    function moveEquipCommand(slotWindow) {
        if (!slotWindow) { slotWindow = SceneManager._scene._slotWindow; }
        // スロットウインドウを終了
        endWindow(slotWindow);
        // コマンドウインドウを開始
        const commandWindow = SceneManager._scene._commandWindow;
        startWindow(commandWindow);
    };


    //- ウインドウの開始
    function startWindow(windo, selectIndex) {
        windo.activate();
        if (windo._index == -1) { windo.select(selectIndex || 0); }
        windo.updateHelp();
        windo.cursorVisible = true;
        windo._updateCursor();
    };

    //- ウインドウの終了
    function endWindow(windo, indexKeep) {
        windo.deactivate();
        if (!indexKeep) { windo.select(-1); }
        windo.updateHelp();
        windo.cursorVisible = false;
        windo._updateCursor();
    };
    ...
    function moveEquipSlot(commandWindow) {
        if (!commandWindow) { commandWindow = SceneManager._scene._commandWindow; }
        // コマンドウインドウを終了
        endWindow(commandWindow);
        // スロットウインドウを開始
        const slotWindow = SceneManager._scene._slotWindow;
        startWindow(slotWindow, -1);
    };
    ...
    //- ウインドウ・エクイップスロット/タッチの処理(処理追加)
    if (Window_EquipSlot.prototype.processTouch == Window_Selectable.prototype.processTouch) {
    ...
    Window_EquipSlot.prototype.processTouch = function() {
        _Window_EquipSlot_processTouch.apply(this);

        // マウスオーバーセレクトの判定
        if (checkMouseOverSelect(this) && !(isItemWindowActive())) {
            // オーバーしたら装備スロットへの移動
            moveEquipSlot();
        };
    };
    ...
    //- ウインドウ・エクイップコマンド/タッチの処理(処理追加)
    if (Window_EquipCommand.prototype.processTouch == Window_Selectable.prototype.processTouch) {
        Window_EquipCommand.prototype.processTouch = function() {
            Window_Selectable.prototype.processTouch.call(this);
        };
    }
    const _Window_EquipCommand_processTouch = Window_EquipCommand.prototype.processTouch;
    Window_EquipCommand.prototype.processTouch = function() {
        _Window_EquipCommand_processTouch.apply(this);
    ...
    //- マウスオーバーセレクトの判定
    function checkMouseOverSelect(windo) {
        // ウインドウがアクティブならリターン
        if (!windo.isOpen() || !windo.visible || windo.active) { return false; }
        // マウスモードでなければリターン
        if (!isMouseMode()) { return false; }
        // マウスオーバー有効でないか、マウスオーバーしていなければリターン
        if (!windo.isHoverEnabled() || !TouchInput.isHovered()) { return false; }
        // ウインドウオーバーしていなければリターン
        if (!isWindowOver(windo)) { return false; }
        return true;
    };


    //- アイテムウインドウがアクティブか
    function isItemWindowActive() {
        const itemWindow = SceneManager._scene._itemWindow;
        return itemWindow && itemWindow.active;
    };
    ...
    //- ウインドウ・エクイップアイテム/所持数表示するか(処理追加)
    if (Window_EquipItem.prototype.needsNumber == Window_ItemList.prototype.needsNumber) {
        Window_EquipItem.prototype.needsNumber = function() {
            return Window_ItemList.prototype.needsNumber.call(this);
        };
    }
    const _Window_ItemList_needsNumber = Window_ItemList.prototype.needsNumber;
    Window_ItemList.prototype.needsNumber = function() {
        // 装備所持数を非表示
        if (keke_hideEquipItemNumber) {
            return false;
        }

        return _Window_ItemList_needsNumber.apply(this);
    };

    //- ウインドウ・エクイップアイテム/所持数の横幅(処理追加)
    if (Window_EquipItem.prototype.numberWidth == Window_ItemList.prototype.numberWidth) {
        Window_EquipItem.prototype.numberWidth = function() {
            return Window_ItemList.prototype.numberWidth.call(this);
        };
    }
    ...
    Window_EquipItem.prototype.numberWidth = function() {
        ...
        return _Window_ItemList_numberWidth.apply(this);
    };
    ...
    //- ウインドウ・エクイップアイテム/アイテム名の描画
    if (Window_EquipItem.prototype.drawItem == Window_ItemList.prototype.drawItem) {
    ...
    Window_EquipItem.prototype.drawItem = function(index) {
        ...
        // アイテムが空の部分に装備外しテキストを描画
        const item = this.itemAt(index);
        const ui = keke_equipRemoveUi;
        if (!item && ui["テキストを表示"] && ui["└テキスト内容"]) {
            const rect = this.itemLineRect(index);
            const textMargin = ImageManager.standardIconWidth + 4;
            this.drawText(ui["└テキスト内容"], rect.x + textMargin, rect.y, rect.width);
        }
    };
    

    //- ウインドウ・エクイップアイテム/項目リストの作成(処理追加)
    if (Window_EquipItem.prototype.makeItemList == Window_ItemList.prototype.makeItemList) {
    ...
    Window_EquipItem.prototype.makeItemList = function() {
        _Window_EquipItem_makeItemList.apply(this);

        // 装備外し欄を一番上にする
        const equipEemovePos = keke_equipRemoveUi["装備外し欄の位置"];
        if (!equipEemovePos || equipEemovePos == "最後") { return; }
        this._data.pop();
	...
	function drawScrollBar(windo, rateY) {
        ...
        // 描画
        fillSquare(bitmap, outW / 2 + offsetX, outW / 2, barW, barH, colors, round);
        if (outW) {
            strokeSquare(bitmap, outW / 2 + offsetX, outW / 2, barW, barH, strokeColor, outW, round);
        }
        // スクロールバックの形成
	...
	function createScrollBack(windo, boxW, boxH, round, rateY, outW) {
        ...
        // 描画
        fillSquare(bitmap, 0, 0, boxW, boxH, color, round);
        // スプライト形成
        const sprite = new SpriteKeMncf(bitmap);
        // チルド
		windo.addChild(sprite);
        ...
        // 配置
        sprite.x = keke_scrollBarDesign["配置方向"] == "左" ? 0 : windo.padding + windo.innerWidth - Math.floor(outW);
    ...
    function putScrollBar(windo) {
		...
		// 配置
        sprite.x = keke_scrollBarDesign["配置方向"] == "左" ?  -sprite._offsetXKe : boxX - sprite._offsetXKe - Math.floor(sprite._outWKe);
        sprite.y = boxY + barY;
    };
    ...
    //- パーティ一覧ウインドウ/テキストレイヤーに描画
    Window_PartyWideLookKe.prototype.drawTextToTextLayer = function(text, x, y, maxWidth, align) {
        // コンテンツのフォント設定をコピー
    ...
    Window_PartyWideLookKe.prototype.createCursor = function(isPending) {
        ...
        const sprite = new SpriteKeMncf(bitmap);
        // 描画
        fillSquare(bitmap, lineW * 0, lineW  *  0, width + lineW * 2, height + lineW * 2, color, round);
        // チルド
    ...
    Window_PartyWideLookKe.prototype.drawFaceKe = function(actor, rect, width, height) {
        ...
        if (!createFaceMake(actor, { window:this, x:faceX, y:faceY, width:faceW, height:faceH })) {
            if (faceName && faceIndex >= 0) {
                context.save();
                designSquare(contents, faceX, faceY, faceW, faceH, round);
                context.clip();
    ...
    Window_PartyWideLookKe.prototype.drawBattleMemberRect = function(index, rect, width, height) {
        ...
        const faceY = rect.y + (faceH < height ? (height - faceH) / 2 : 0);
        // 描画
        strokeSquare(this._textContents, faceX, faceY, faceW, faceH, color, rectW, round);
    };
    ...
    Window_PartyWideLookKe.prototype.drawName = function(actor, index, rect) {
        ...
        this.drawTextToTextLayer(name, x, y, width, align);
        // フォント設定のロード
    ...
    Window_PartyWideLookKe.prototype.drawLevel = function(actor, index, rect) {
        ...
        this.drawTextToTextLayer(label, x, y, labelW);
        contents.textColor = color;
        this.drawTextToTextLayer(level, x + labelW, y, levelW);
        // 最大レベル
        ...
        if (maxLevel) {
            ...
            this.drawTextToTextLayer(maxLevelText, x + textW, y, maxLevelW);
        }*/
        // フォント設定のロード
        loadFontCfg(contents, fontSave);
    };

    //- パーティ一覧ウインドウ/ステートアイコンの描画
    ...
    Window_PartyWideLookKe.prototype._updateCursor = function() {
        ...
        Window_MenuStatus.prototype.updateCursor.call(this);
    };
    ...
    //- パーティ一覧ウインドウ/ペイント
    Window_PartyWideLookKe.prototype.paint = function() {
        // テキストレイヤーもクリア
        this._textContents.clear();

        Window_MenuStatus.prototype.paint.call(this);
    };

    //- パーティ一覧ウインドウ/項目のクリア
    Window_PartyWideLookKe.prototype.clearItem = function(index) {
        Window_MenuStatus.prototype.clearItem.call(this, index);
        
        // テキストレイヤーもクリア
        rect = this.itemRect(index);
        const outW = this._textContents.outlineWidth;
        this._textContents.clearRect(rect.x - outW / 2, rect.y - outW / 2, rect.width + outW, rect.height + outW);
    };
    ...
    Window_PartyWideLookKe.prototype.drawStatus = function(actor, index, rect) {
        ...
        const gaugeNum = getGaugeNum();
        const totalH = lineH * gaugeNum + lineSpace * (gaugeNum - 1);
        // 位置
    ...
    //- ゲージ本数の取得
    function getGaugeNum() {
        if (!keke_statusShowContents || !Object.keys(keke_statusShowContents).length) { return true; }
        let num = 0;
        const shows = keke_statusShowContents;
        if (isShow(shows["HPの表示"])) { num++; }
        if (isShow(shows["MPの表示"])) { num++; }
        if (isShow(shows["TPの表示"])) { num++; }
        return num;
    };
    ...
    Window_MenuStatus.prototype.drawItemImage = function(index) {
        ...
        NoTranslucent = false;
        // バトラーマークの処理
        processBattlerMark(this, index);
    };

    //- バトラーマークの処理
    function processBattlerMark(windo, index) {
        ...
        // 顔グラメイクへのクリア
        clearToFaceMake(actor, windo);
        // 戦闘メンバーならバトラーマークの描画
        if (index < battleNum) {
            drawBattlerMark(windo, index, cfg, actor);
        // 補欠なら補欠マークの描画
        } else {
            drawSubMark(windo, index, cfg, actor);
        }
    };

    //- バトラーマークの描画
    function drawBattlerMark(windo, index, cfg, actor) {
        if (!keke_showBattlerMark) { return; }
        const text = cfg["テキスト"] || "Battler";
        // マークの描画
        drawMark(windo, index, cfg, actor, text);
    };

    //- 補欠マークの描画
    function drawSubMark(windo, index, cfg, actor) {
        if (!keke_showSubMark) { return; }
        const text = cfg["補欠テキスト"] || "Sub";
        // マークの描画
        drawMark(windo, index, cfg, actor, text);
    };

    //- マークの描画
    function drawMark(windo, index, cfg, actor, text) {
        const rect = windo.itemRect(index);
        const fontSize = cfg["文字サイズ"] || 16;
    ...
    //- アイコンバックの描画
    function drawIconBack(bitmap, iconIndex, x = 0, y = 0) {
        ...
        const outW = design["縁取り幅"] || 0;
        const outColor = design["縁取り色"] || "rgba(0, 0, 0, 1)";
        const round =  design["丸み"] || 10;
        // 描画
        fillSquare(bitmap, x, y, iw, ih, backColor, round);
        strokeSquare(bitmap, x, y, iw, ih, outColor, outW, round);
    };

    //- アイコンバックを描画するか
    function isIconBackDraw() {
        return keke_showIconBack;
    };
    ...
    Window_StatusBase.prototype.placeGauge = function(actor, type, x, y) {
        // 該当タイプのゲージ表示しないならリターン
        if (!isStatusShow(type)) { return; }

        _Window_StatusBase_placeGauge.call(this, actor, type, x, y, );
    };


    //- ウインドウステータスベース/レベルの描画(処理追加)
    ...
    //- ステータス表示するか
    function isStatusShow(type) {
        if (!keke_statusShowContents || !Object.keys(keke_statusShowContents).length) { return true; }
        if (!type || !type.match(/レベル|hp|mp|tp/i)) { return true; }
        return isShow(keke_statusShowContents[type.toUpperCase() + "の表示"]);
    };
    ...
    function isTouchInput(scene) {
        ...
        if (TouchInput.isTriggered() || TouchInput.isCancelled()) { ok = true; }
        if (TouchInput.isMoved() || TouchInput.isHovered()) { ok = true; }
        if (ok) {
    ...
    //- スクエアの塗り潰し
    function fillSquare(bitmap, x, y, w, h, color = "rgba(0,0,0,1)", roundEdge = 0, roundLine = 0, corner = "") {
        ...
        designSquare(bitmap, x, y, w, h, roundEdge, roundLine, corner);
        context.fill();
        context.restore();
    ...
    //- スクエアの線画
    function strokeSquare(bitmap, x, y, w, h, color = "rgba(0,0,0,1)", lineW = 1,  roundEdge = 0, roundLine = 0, corner = "") {
        const context = bitmap.context;
        context.strokeStyle = color;
        context.lineWidth = lineW;
        designSquare(bitmap, x, y, w, h, roundEdge, roundLine, corner, lineW);
        context.stroke();
        context.restore();
        bitmap._baseTexture.update();
    };
    ...
    //- スクエアのデザイン
    function designSquare(bitmap, x, y, w, h, roundEdge = 0, roundLine = 0, corner = "", lineW = 0, airUp) {
        const context = bitmap.context;
        context.beginPath();
        const x2 = x + w / 2;
        const y2 = y + h / 2;
